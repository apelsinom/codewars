// ❓ DESCRIPTION:
// Johnny is a farmer and he annually holds a beet farmers
// convention "Drop the beet".
...
// that participated this year just
// by counting all the handshakes.
// Help Johnny by writing a function, that takes the amount of
// handshakes and returns the minimal
// amount of people needed to perform these handshakes (a pair
// of farmers handshake only once).

// ✅ SOLUTION:
function getParticipants(handshakes){
  let minFarmers = 1;
  let maxHandshackes = 0;
  while (handshakes > maxHandshackes) {
    maxHandshackes = (((minFarmers - 1)) / 2) * minFarmers
    minFarmers += 1;
  }
  return minFarmers - 1;
}
